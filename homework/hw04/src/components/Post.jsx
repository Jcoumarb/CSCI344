            ...
            <div className="p-4">
                <div className="flex justify-between text-2xl mb-3">
                    <div className="flex gap-2">
                        <LikeButton likeId={postData.current_user_like_id} id={postData.id} token={token} />
                    ...
                    <div>
                        <BookmarkButton bookmarkId={postData.current_user_bookmark_id} id={postData.id} token={token} />
                    </div>
                </div>
